...
from openstack_sdk import password_authentication_with_scoped_authorization, assign_role_to_user_on_project, create_project, list_projects, create_network, create_subnet, create_port, get_server_console, create_server, list_flavors, list_images, token_authentication_with_scoped_authorization, password_authentication_with_unscoped_authorization
import os
...
def create_topology(vm_list, type_topology, topology_name, topology_description, user_id):
    ...
    if type_topology == 'Anillo':
        print("Esta topologia es anillo")
