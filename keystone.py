...
class KeystoneAuth(object):
    def __init__(self,username, password):
        self.auth_url = "http://10.20.10.10:50080/v3"
...
#Obtener TOKEN por proyecto
    ...
    def asignarUsuarioProyecto(self,username):
        ...
        if (user_id is not None) and (role_id is not None):
            ...
            if response.status_code == 204:
                print("[*] Se ha asignado al usuario "+ username+" al proyecto  correctamente con el rol de usuario\n")
    ...
    def eliminarUsuarioProyecto(self,username):
        ...
        if (user_id is not None) and (role_id is not None):
            ...
            if response.status_code == 204:
                print("[*] Se ha eliminado al usuario "+ username +" del proyecto correctamente")
        ...
        if response.status_code == 200:
            ...
            for user in users:
                ...
                if response.status_code == 200:
                    ...
                    print("[*] Hubo un problema al listar los proyectos del usuario\n")
